...
# --- Содержимое файлов ---
# Используем обычные кавычки и символ ` для экранирования, если нужно.
# В данном случае, проблема была с Here-String @"...">@ и скобками внутри.
# Создадим строки построчно и соединим.
...
$logLines = @(
    ...
    "- Configured global Git user info (`user.email`, `user.name`).", # <-- Это строка была проблемной
